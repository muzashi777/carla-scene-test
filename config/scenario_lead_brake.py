...
LEAD_DECEL         = 9.0   # ความหน่วงตอนรถนำเบรก (m/s²) — สูง = เบรกแรง/กระทันหัน
...
SINGLE_CASE = dict(
    ...
    headway_d      = 20.0,    # ระยะห่างรถนำ-ego ตอนเริ่ม (เมตร) — รักษาคงที่จนรถนำเบรก
)
...
MATRIX = dict(
    ...
    headway_d      = [10.0, 15.0, 20.0, 25.0],   # ระยะห่างรถ (ม.)
